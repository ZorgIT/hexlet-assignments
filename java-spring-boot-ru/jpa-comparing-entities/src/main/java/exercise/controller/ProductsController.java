...
public class ProductsController {
    ...
    public ResponseEntity<Product> create(@RequestBody Product product) {
        // Check if product with the same title and price already exists
        var existingProduct = productRepository.findByTitleAndPrice(product.getTitle(), product.getPrice());
