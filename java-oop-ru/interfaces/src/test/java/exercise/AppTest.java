...
class AppTest {
    ...
    void testReversedSequence() {
        ...
        String expect1 = text.toString();
        assertThat(expect1).isEqualTo("fedcba");

        char expect2 = text.charAt(1);
        assertThat(expect2).isEqualTo('e');

        int expect3 = text.length();
        assertThat(expect3).isEqualTo(6);

        String expect4 = text.subSequence(1, 4).toString();
        assertThat(expect4).isEqualTo("edc");
    }
    // END
}
